...
package br.com.lemontech.triprequestmanager.selfbooking.wsselfbooking.services.response;
...
import br.com.lemontech.triprequestmanager.selfbooking.wsselfbooking.beans.types.ResultadoAcao;
...
public class PesquisarSolicitacaoResponse {
    ...
    /**
     * Obt�m o valor da propriedade resultadoAcao.
     * 
     * @return
     *     possible object is
     *     {@link ResultadoAcao }
    ...
    /**
     * Obt�m o valor da propriedade numeroSolicitacoes.
     * 
     * @return
     *     possible object is
     *     {@link Integer }
	...
	public String toString() {
		return "PesquisarSolicitacaoResponse [resultadoAcao=" + resultadoAcao + ", numeroSolicitacoes="
				+ numeroSolicitacoes + ", solicitacao=" + solicitacao + ", mensagemRetorno=" + mensagemRetorno + "]";
	}
